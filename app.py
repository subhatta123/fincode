...
from render_config import RENDER_CONFIG, setup_render_environment

# Load environment variables from .env file
load_dotenv()

# Setup Render environment if needed
